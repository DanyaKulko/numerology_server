...
export const STRUCTURE_COMPATIBILITY: MatrixSectionConfig[] = [
    ...
    {
        categorySlug: 'compat_man',
        items: [
            {positionSlug: 'compat_man_f', matrixKey: 'f'},
        ]
    },
    {
        categorySlug: 'compat_woman',
        items: [
            {positionSlug: 'compat_woman_g', matrixKey: 'g'},
        ]
    },
    {
        categorySlug: 'compat_partner_as_parents',
        items: [
            {positionSlug: 'compat_partner_as_parents_a2', matrixKey: 'a2'},
        ]
    },
    {
        categorySlug: 'compat_child_teach_parents',
        items: [
            {positionSlug: 'compat_child_teach_parents_a1', matrixKey: 'a1'},
        ]
    },
    {
        categorySlug: 'compat_carma_tasks',
        items: [
            {positionSlug: 'compat_carma_tasks_d', matrixKey: 'd'},
        ]
    },
    {
        categorySlug: 'compat_tasks_problems',
        items: [
            {positionSlug: 'compat_tasks_problems_c', matrixKey: 'c'},
        ]
    }
];
